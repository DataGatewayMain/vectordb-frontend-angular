...
@Component({
  selector: 'app-exporthistorydialogue',
  templateUrl: './exporthistorydialogue.component.html',
  styleUrl: './exporthistorydialogue.component.css'
  
})
export class ExporthistorydialogueComponent {
  filters: any;
  selectedRows: any[] = [];
...
private saveExportHistory(apikey: string, dataToExport: any[]): Promise<void> {
    return new Promise((resolve, reject) => {
        this.http.post(' https://exporthistory.onrender.com/saveExportHistory', { apikey, dataToExport }, { responseType: 'text' })
            .subscribe(
              (                response: any) => {
