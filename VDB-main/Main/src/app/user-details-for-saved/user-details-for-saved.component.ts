...
@Component({
  selector: 'app-user-details-for-saved',
  templateUrl: './user-details-for-saved.component.html',
  styleUrls: ['./user-details-for-saved.component.css']
})
export class UserDetailsForSavedComponent {
  filters: any = {}; 
  ...
  constructor(
    ...
    private ref: MatDialogRef<UserDetailsForSavedComponent>,
