...
@Component({
  selector: 'app-bulk-inbox-email',
  standalone: true,
  imports: [
    CommonModule, // Include CommonModule for *ngIf and *ngFor
    ReactiveFormsModule,
    FormsModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  templateUrl: './bulk-inbox-email.component.html',
  styleUrl: './bulk-inbox-email.component.css'
})
export class BulkInboxEmailComponent {
  userEmail: any;
  userFirstName: any;
  userLastName: any;
  userapi_key: any;
  ...
  constructor(private http: HttpClient,
    ...
    private dialogRef: MatDialogRef<BulkInboxEmailComponent>,
